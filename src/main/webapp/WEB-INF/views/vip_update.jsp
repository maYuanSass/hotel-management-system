        ...
        <div class="right">
            ...
            <form class="layui-form " action="${pageContext.request.contextPath}/vip/update2" onsubmit="return sumbit_sure()" >
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <select name="Sex" class="layui-input" autocomplete="off" lay-verify="required" required  value="${v.sex}" >
                            <option value=""></option>
                            <option value="男" selected="${v.sex =='男'?'true':''}" >男</option>
                            <option value="女" selected="${v.sex =='女'?'true':''}" >女</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <select name="Vtype" class="layui-input" required lay-verify="required" value="${v.vtype}">
                            <option value=""></option>
                            <option value="初级会员" selected="${v.vtype =='初级会员'?'true':''}">初级会员</option>
                            <option value="中级会员" selected="${v.vtype =='中级会员'?'true':''}">中级会员</option>
                            <option value="高级会员" selected="${v.vtype =='高级会员'?'true':''}">高级会员</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    <div class="layui-input-block">
                        <input type="submit" class="layui-btn" lay-submit lay-filter="formDemo" value="确认修改" />
